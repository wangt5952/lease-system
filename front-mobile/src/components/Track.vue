    ...
    <div>
      <view-box ref="viewBox">
        ...
        <baidu-map @ready="rdy" :center="center" :zoom="zoom" :dragging="true" :pinch-to-zoom="true" class="bmap">
          ...
          <bm-marker :position="center" :dragging="false" animation="BMAP_ANIMATION_BOUNCE" :icon="{ url: '/static/images/Red_Point.jpg', size: { width: 19, height: 25 }, opts: { imageSize: { width: 19, height: 25 } } }"></bm-marker>
        </baidu-map>
      </view-box>
  </div>
</template>
