...
<div class="resPw">
    ...
    <div class="resPw-header">
      <div class="header-font">
        ...
        &nbsp;
        <div style="margin-top:4px;font-size:23px;color:#F2F2F2">小哥乐途</div>
        <div class="longinButton">
          <el-button type="info" size="medium">登录</el-button>
        </div>
      ...
      <div class="resPw-body">
        ...
        <div class="resPw-body-center">  
          <div style="flex:1;border-bottom:solid 1.5px #EBEBEB;">
            <div style="background:url(/static/half-ring-15.png);width:45px;height:67px;position: absolute;left:42%;top:90px"></div>
            <div style="font-size:33px;width:180px;margin:3% 40% 0px 45% ">忘记密码</div>
          </div>
          
          <div style="flex:3;display:flex;flex-direction:column;">
            <div style="background:url(/static/half-ring-13.png);
            ...
            <el-form :model="form">
              <div style="width:410px;height:50px;margin:10px 430px 10px 430px">
                <el-form-item>
                  <el-input v-model="form.userMobile" style="width: 300px; height: 35px;" placeholder="请输入您的手机号" clearable></el-input>
                  <el-button style="width: 90px; height: 35px;" type="primary" :disabled="state">获取验证码</el-button>
                </el-form-item>
              </div>
              ...
              <div class="nextButton" style="width: 100px; height: 35px;margin:10px 430px 10px 430px">
                <el-button style="width: 100px; height: 35px;" 
                    type="primary" @click="validateMobileNumber">下一步</el-button>
              </div>
          </div>
        </div>
    ...
    <template v-if="stepNo2">
      <div class="resPw-body">
        ...
        <div class="resPw-body-center">  
          ...
          <div style="flex:3;display:flex;flex-direction:column;">
            <div style="background:url(/static/half-ring-14.png);
                width:470px;height:40px;margin:20px 350px">
            </div>
            ...
            <el-form :model="form">
              <div style="width:300px;height:50px;margin:10px 430px 10px 430px">
                <el-form-item>
                  <el-input v-model="form.newPassword" placeholder="请输入新密码" clearable></el-input>
                </el-form-item>
              </div>
              <div style="width:300px;height:50px;margin:10px 430px 10px 430px">
                <el-form-item>
                  <el-input v-model="confirmNewPassword" placeholder="请再次输入新密码" clearable></el-input>
                </el-form-item>
              </div>
            </el-form>
            <div class="nextButton" style="width: 300px; height: 35px;margin:10px 430px 10px 430px;">
              <el-button style="width: 100px; height: 35px;" type="primary">完成</el-button>
              <el-button style="width: 100px; height: 35px;margin-left:95px" type="info">取消</el-button>
            </div>
          </div>
        </div>
        <div class="resPw-body-right"></div>
...
export default {
  ...
  methods:{
    ...
    async validateMobileNumber(){
      let data = await this.$http.post('/api/manager/auth/resetPassword',form);
      console.log(data);
    }
  },
}
