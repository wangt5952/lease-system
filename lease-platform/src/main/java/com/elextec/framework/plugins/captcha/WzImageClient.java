...
public class WzImageClient {
    ...
    public String madeAndGetCapthaUrl(String captchaCode, int widthPx, int heightPx) {
        ...
        String imageFullName = WzFileUtil.madeFilePath(uploadCaptchaRoot, "", imageName, WzFileUtil.EXT_JPG);
        ...
        return WzFileUtil.madeRequestUrl(downloadCaptchaPrefix,"", imageName);
    }
    ...
    public String madeAndGetUserIconUrl(String fileBase64Data) {
        ...
        return WzFileUtil.madeRequestUrl(downloadUserIconPrefix,"", imageName + WzFileUtil.EXT_JPG);
    }
    ...
    public String madeAndGetUserRealAuthUrl(String fileBase64Data) {
        ...
        return WzFileUtil.madeRequestUrl(downloadUserRealnamePrefix,"", imageName + WzFileUtil.EXT_JPG);
    }
